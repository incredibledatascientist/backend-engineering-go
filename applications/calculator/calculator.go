...
func main() {
	...
	// Use %f for fixed precision, %g for human-readable CLI output.

	operator := arguments[2]
	switch operator {
	case "+":
		fmt.Printf("Addition of %g+%g=%g\n", num1, num2, num1+num2)
	case "-":
		fmt.Printf("Substraction of %g-%g=%g\n", num1, num2, num1-num2)
	case "*":
		fmt.Printf("Multiplication of %g*%g=%g\n", num1, num2, num1*num2)
	case "/":
		if num2 == 0 {
		...
		fmt.Printf("Division of %g/%g=%0.2f\n", num1, num2, num1/num2)
